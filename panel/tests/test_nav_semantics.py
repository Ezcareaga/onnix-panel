...
def test_todos_los_items_del_menu_anuncian_si_son_el_actual():
    ...
    # Eran 8. Se fueron Propiedades, Tutoriales y Salud del Bot con el vertical
    # y el bot, y despues Stats. El piso no es decorativo: si el regex se
    # rompe, el assert de abajo pasa vacio.
    assert items >= 5, f"solo se encontraron {items} items de menu"
